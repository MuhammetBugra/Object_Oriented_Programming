...
class Secretary implements Staff {
    ...
    Undergraduate [][]undergraduateStudentList = new Undergraduate[10][100];
    Graduate [][]graduateStudentList = new Graduate[10][50];
    Undergraduate []totalUndergraduateStudent = new Undergraduate[100];
    Graduate []totalGraduateStudent = new Graduate[50];
    Courses []totalGraduateCourse = new Courses[100];
    Courses []totalUndergraduateCourse = new Courses[100];
    Lecturers []totalLecturers = new Lecturers[50];
